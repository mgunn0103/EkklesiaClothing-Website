...
function pexeto_load_meta_boxes(){
	...
	array(
		...
		this thumbnail image, you have to set its URL in this field.<br />
		Use the "<b>Upload</b>" button to upload a new image. If you would like to select an image from the Media Library,
		click on the "<b>Use Media Library</b>" button. Once you select the image, click on the "Insert into post" button.'
		),
		...
		will be automatically generated by the image set in this field.<br />
		Use the "<b>Upload</b>" button to upload a new image. If you would like to select an image from the Media Library,
		click on the "<b>Use Media Library</b>" button. Once you select the image, click on the "Insert into post" button.'
		),
