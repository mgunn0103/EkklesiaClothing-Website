...
$sociable_icons=array('', 'facebook.png', 'twitter.png', 'googleplus.png', 'google-plus2.png', 'rss.png', 'flickr.png', 'delicious.png', 'skype.png', 'youtube.png', 'vimeo.png', 'blogger.png', 'linkedin.png', 'myspace.png', 'reddit.png', 'dribbble.png', 'forrst.png', 'deviant-art.png', 'digg.png', 'github.png', 'lastfm.png', 'sharethis.png', 'stumbleupon.png', 'tumblr.png', 'wordpress.png', 'yahoo.png', 'amazon.png', 'apple.png', 'bing.png', 'pinterest.png', '500px.png', 'instagram.png');
...
array(
"type" => "documentation",
"text" => '<h2 class="option-section-title">Gallery slider sharing icons</h2>' ),

array(
"name" => "Display share icons in slider",
